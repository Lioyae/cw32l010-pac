...
#[doc = "Field `RSTIO` reader - desc RSTIO"]
pub type RstioR = crate::BitReader;
#[doc = "Field `RSTIO` writer - desc RSTIO"]
pub type RstioW<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `RTCLPM` reader - desc RTCLPM"]
pub type RtclpmR = crate::BitReader;
#[doc = "Field `RTCLPM` writer - desc RTCLPM"]
pub type RtclpmW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    #[doc = "Bit 0 - desc RSTIO"]
    #[inline(always)]
    pub fn rstio(&self) -> RstioR {
        RstioR::new((self.bits & 1) != 0)
    }
    ...
    #[doc = "Bit 7 - desc RTCLPM"]
    #[inline(always)]
    pub fn rtclpm(&self) -> RtclpmR {
        RtclpmR::new(((self.bits >> 7) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - desc RSTIO"]
    #[inline(always)]
    pub fn rstio(&mut self) -> RstioW<'_, Cr2Spec> {
        RstioW::new(self, 0)
    }
    #[doc = "Bit 1 - desc SWDIO"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - desc RTCLPM"]
    #[inline(always)]
    pub fn rtclpm(&mut self) -> RtclpmW<'_, Cr2Spec> {
        RtclpmW::new(self, 7)
    }
    #[doc = "Bit 10 - desc HSEBRKEN"]
    #[inline(always)]
