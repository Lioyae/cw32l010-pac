...
impl W {
    ...
    #[doc = "Bit 1 - desc SNGSTART"]
    #[inline(always)]
    pub fn sngstart(&mut self) -> SngstartW<'_, CrSpec> {
        SngstartW::new(self, 1)
    }
    #[doc = "Bit 2 - desc CNTSTART"]
    #[inline(always)]
    pub fn cntstart(&mut self) -> CntstartW<'_, CrSpec> {
        CntstartW::new(self, 2)
    }
    #[doc = "Bit 3 - desc SRST"]
    #[inline(always)]
    pub fn srst(&mut self) -> SrstW<'_, CrSpec> {
        SrstW::new(self, 3)
    }
    #[doc = "Bit 4 - desc ARST"]
    #[inline(always)]
    pub fn arst(&mut self) -> ArstW<'_, CrSpec> {
        ArstW::new(self, 4)
    }
}
