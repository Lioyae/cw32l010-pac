...
#[doc = "Field `SCLINSRC` reader - desc SCLINSRC"]
pub type SclinsrcR = crate::FieldReader;
#[doc = "Field `SCLINSRC` writer - desc SCLINSRC"]
pub type SclinsrcW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `SDAINSRC` reader - desc SDAINSRC"]
pub type SdainsrcR = crate::FieldReader;
#[doc = "Field `SDAINSRC` writer - desc SDAINSRC"]
pub type SdainsrcW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
impl R {
    #[doc = "Bit 0 - desc FLT"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:10 - desc SCLINSRC"]
    #[inline(always)]
    pub fn sclinsrc(&self) -> SclinsrcR {
        SclinsrcR::new(((self.bits >> 8) & 7) as u8)
    }
    #[doc = "Bits 11:13 - desc SDAINSRC"]
    #[inline(always)]
    pub fn sdainsrc(&self) -> SdainsrcR {
        SdainsrcR::new(((self.bits >> 11) & 7) as u8)
    }
}
impl W {
    #[doc = "Bit 0 - desc FLT"]
    ...
    #[doc = "Bits 8:10 - desc SCLINSRC"]
    #[inline(always)]
    pub fn sclinsrc(&mut self) -> SclinsrcW<'_, CrSpec> {
        SclinsrcW::new(self, 8)
    }
    #[doc = "Bits 11:13 - desc SDAINSRC"]
    #[inline(always)]
    pub fn sdainsrc(&mut self) -> SdainsrcW<'_, CrSpec> {
        SdainsrcW::new(self, 11)
    }
}
