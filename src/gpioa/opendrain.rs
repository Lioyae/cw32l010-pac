#[doc = "Register `OPENDRAIN` reader"]
pub type R = crate::R<OpendrainSpec>;
#[doc = "Register `OPENDRAIN` writer"]
pub type W = crate::W<OpendrainSpec>;
...
impl W {
    #[doc = "Bit 0 - desc PIN0"]
    #[inline(always)]
    pub fn pin0(&mut self) -> Pin0W<'_, OpendrainSpec> {
        Pin0W::new(self, 0)
    }
    #[doc = "Bit 1 - desc PIN1"]
    #[inline(always)]
    pub fn pin1(&mut self) -> Pin1W<'_, OpendrainSpec> {
        Pin1W::new(self, 1)
    }
    #[doc = "Bit 2 - desc PIN2"]
    #[inline(always)]
    pub fn pin2(&mut self) -> Pin2W<'_, OpendrainSpec> {
        Pin2W::new(self, 2)
    }
    #[doc = "Bit 3 - desc PIN3"]
    #[inline(always)]
    pub fn pin3(&mut self) -> Pin3W<'_, OpendrainSpec> {
        Pin3W::new(self, 3)
    }
    #[doc = "Bit 4 - desc PIN4"]
    #[inline(always)]
    pub fn pin4(&mut self) -> Pin4W<'_, OpendrainSpec> {
        Pin4W::new(self, 4)
    }
    #[doc = "Bit 5 - desc PIN5"]
    #[inline(always)]
    pub fn pin5(&mut self) -> Pin5W<'_, OpendrainSpec> {
        Pin5W::new(self, 5)
    }
    #[doc = "Bit 6 - desc PIN6"]
    #[inline(always)]
    pub fn pin6(&mut self) -> Pin6W<'_, OpendrainSpec> {
        Pin6W::new(self, 6)
    }
    #[doc = "Bit 7 - desc PIN7"]
    #[inline(always)]
    pub fn pin7(&mut self) -> Pin7W<'_, OpendrainSpec> {
        Pin7W::new(self, 7)
    }
    #[doc = "Bit 8 - desc PIN8"]
    #[inline(always)]
    pub fn pin8(&mut self) -> Pin8W<'_, OpendrainSpec> {
        Pin8W::new(self, 8)
    }
}
#[doc = "desc OPENDRAIN\n\nYou can [`read`](crate::Reg::read) this register and get [`opendrain::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opendrain::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct OpendrainSpec;
impl crate::RegisterSpec for OpendrainSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`opendrain::R`](R) reader structure"]
impl crate::Readable for OpendrainSpec {}
#[doc = "`write(|w| ..)` method takes [`opendrain::W`](W) writer structure"]
impl crate::Writable for OpendrainSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets OPENDRAIN to value 0"]
impl crate::Resettable for OpendrainSpec {}
