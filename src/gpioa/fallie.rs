#[doc = "Register `FALLIE` reader"]
pub type R = crate::R<FallieSpec>;
#[doc = "Register `FALLIE` writer"]
pub type W = crate::W<FallieSpec>;
...
#[doc = "Interrupt enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`fallie::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fallie::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct FallieSpec;
impl crate::RegisterSpec for FallieSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fallie::R`](R) reader structure"]
impl crate::Readable for FallieSpec {}
#[doc = "`write(|w| ..)` method takes [`fallie::W`](W) writer structure"]
impl crate::Writable for FallieSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FALLIE to value 0"]
